...
@section('subcontent')
<form action="{{ route('nivel.show') }}" method="GET" id="searchForm">
      ...
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        ...
        @else
              ...
              <tr class="bg-white border-b">
                ...
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                  <a href="{{ route('nivel.editando', $apoderado->id_nivel) }}" 
          ...
          <div class="mt-4">
            {{ $niveles->links() }} <!-- Esto genera los enlaces de paginación -->
        </div>
        </div>
      </div>
    </div>
