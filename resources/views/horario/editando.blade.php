        ...
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
            ...
            <div class="container mx-auto p-6">
                ...
                <div class="overflow-x-auto">
                    <!-- Crear la tabla con las horas a la izquierda y los días de la semana arriba -->
                        ...
                        <tbody class="text-gray-700">
                            @foreach($horarios->groupBy('idHora') as $hora => $horariosHora)
                                <tr class="hover:bg-gray-50 transition-colors duration-300">
                                    <!-- Mostrar la hora a la izquierda -->
                                    ...
                                    @foreach($horarios->groupBy('idDiaSemana') as $diaSemana => $horariosDia)
                                        <!-- Mostrar los ACU ID de cada hora y día en las celdas -->
                                        <td class="p-4 border-t border-r border-gray-300 text-center bg-white">
                                            @foreach($horariosHora->where('idDiaSemana', $diaSemana) as $horario)
                                                <!-- Si el acu_id está vacío, cambiar el color -->
                                                <div class="text-sm 
                                                ...
                                                @else
                                                    bg-transparent 
                                                @endif">
                                                <!-- Verificamos si el curso existe y tiene acu_nombre -->
            ...
            <div class="flex justify-end mt-6">
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <a href="{{route('horario.show')}}" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" >Regresar</a>
