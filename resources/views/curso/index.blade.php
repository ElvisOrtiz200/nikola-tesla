...
<h1 class="text-3xl">Administración de cursos</h1>
    ...
    <header class="bg-white">
        <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-teal-700 lg:px-8">
            <nav class="hidden lg:flex lg:space-x-8 lg:py-2" aria-label="Global">
                ...
                <a href="{{route('curso.create')}}" id="btn-registrar" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium" aria-current="page" onclick="handleButtonClick(this, 'btn-registrar')">Registrar</a>
                ...
                <a href="{{route('curso.eliminar')}}" id="btn-projects" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium" onclick="handleButtonClick(this, 'btn-projects')">Eliminar</a>
                <a href="{{route('curso.listar')}}" id="btn-calendar" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 inline-flex items-center rounded-md py-2 px-3 text-sm font-medium" onclick="handleButtonClick(this, 'btn-calendar')">Listar</a>
            </nav>
            ...
            <nav class="lg:hidden" aria-label="Global" id="mobile-menu">
              <div class="space-y-1 px-2 pb-3 pt-2">
                ...
                <a href="{{route('curso.create')}}" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 block rounded-md py-2 px-3 text-base font-medium" aria-current="page" onclick="handleButtonClick(this, 'btn-registrar')">Registrar</a>
                ...
                <a href="{{route('curso.eliminar')}}" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 block rounded-md py-2 px-3 text-base font-medium" onclick="handleButtonClick(this, 'btn-projects')">Eliminar</a>
                <a href="{{route('curso.listar')}}" class="text-cyan-500 bg-yellow-400 hover:bg-cyan-500 hover:text-yellow-400 block rounded-md py-2 px-3 text-base font-medium" onclick="handleButtonClick(this, 'btn-calendar')">Listar</a>
              </div>
