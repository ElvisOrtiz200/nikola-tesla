...
@section('subcontent')
<form action="{{ route('recursoshh.eliminar') }}" method="GET" id="searchForm">
...
<div class="flex flex-col">
    <div class="overflow-x-auto sm:mx-0.5 lg:mx-0.5">
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        ...
        @else
        @foreach ($rrhh as $userrrhh)
        <tr class="bg-white border-b">
            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                {{ $userrrhh->per_apellidos }}
              </td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                {{ $userrrhh->per_nombres }}
              </td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                  {{ $userrrhh->per_cargo }}
              </td>
          ...
          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
            ...
            <a href="{{ route('recursoshh.eliminando', $userrrhh->per_id) }}" 
