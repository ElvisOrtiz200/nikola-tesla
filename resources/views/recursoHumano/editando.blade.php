...
<section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
    ...
    <form id="roledit" action="{{ route('recursoshh.update', $rrhh->per_id) }}" method="POST">
        @csrf
    @method('PUT') 
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                <label class="text-gray-700 dark:text-gray-200" >Cargo</label>
            ...
            <div>
                <label class="text-gray-700 dark:text-gray-200" >DNI</label>
            ...
            <div id="date-range-picker" class="flex items-center">
                <label class="text-gray-700 dark:text-gray-200" >Contrato</label>
                <div class="relative">
        ...
        <div class="flex justify-end mt-6">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <a href="{{route('recursoshh.show')}}" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" >Regresar</a>
