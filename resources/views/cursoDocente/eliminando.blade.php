...
<section class="max-w-4xl p-6 mx-auto bg-white rounded-md drop-shadow-2xl dark:bg-gray-800">
    ...
    {{-- {{ route('cursodocente.update', $cursoDocente->acdo_id) }} --}}
    <form action="{{ route('cursodocente.delete', $cursoDocente->acdo_id) }}" method="POST" class="space-y-6">
        @csrf
        @method('DELETE')
        ...
        <div class="">
            ...
            <input type="text" value="{{ $cursoDocente->grado->nombre }}" class="block w-full mt-1 p-3 bg-white border border-gray-300 rounded-lg shadow-sm text-gray-700 dark:bg-gray-800 dark:text-gray-300" readonly />
        </div>
...
<div>
    ...
    <select id="example-select4" name="acu_id" class="block w-full mt-1 p-3 bg-white border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-gray-700 dark:bg-gray-800 dark:text-gray-300" disabled>
...
<div>
    ...
    <select id="selectOption" name="per_id" class="block w-full mt-1 p-3 bg-white border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-gray-700 dark:bg-gray-800 dark:text-gray-300" disabled>
        ...
        <div class="flex justify-end">
            <a href="{{route('cursodocente.eliminar')}}" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" >Regresar</a>
