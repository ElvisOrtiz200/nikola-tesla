      ...
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        ...
        @else
              ...
              <tr class="bg-white border-b">
                ...
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                  {{ $apoderado->apo_apellidos }}
                </td>
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                    {{ $apoderado->apo_nombres }}
                </td>
               
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap" style="max-width: 200px; overflow-x: auto; white-space: nowrap;">
                  {{ $apoderado->apo_direccion }}
              </td>
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                    {{ $apoderado->apo_telefono }}
                </td>
               
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                  <a href="{{ route('apoderado.editando', $apoderado->apo_dni) }}" 
          ...
          <div class="mt-4">
            {{ $apoderados->links() }} <!-- Esto genera los enlaces de paginación -->
        </div>
        </div>
      </div>
    </div>
